...
from .main import bp
from .utility import gen_json_string_summary_accuracy, gen_json_string_summary_frequency, get_max_date_range
...
def one_deck(deck_id):
    ...
    return render_template("statistics/one_deck.html", terms=terms,
